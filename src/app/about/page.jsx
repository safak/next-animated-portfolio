          ...
          <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:1/2">
            ...
            {/* EXPERIENCE LIST ITEM */}
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">Freelance</div>
                {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    My current employment. way better than the previous position and getting new knowledge!
                  </div>
                {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">2023- present</div>
                {/* COMPANY NAME */}
                  <div className="p-1 rounded bg-white text-sm font-semibold w-fit">ArifPay</div>
                </div>
                {/* CENTER */}
                <div className="w-1/6">
                  {/* LINE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                    {/* JOB TITLE */}
                      <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">Internship</div>
                    {/* JOB DESC */}
                      <div className="p-3 text-sm italic">
                        Developing three mobile app with different projects with different client. way better than the previous position and getting new knowledge!
                      </div>
                    {/* JOB DATE */}
                      <div className="p-3 text-red-400 text-sm font-semibold">2023- 2023</div>
                    {/* COMPANY NAME */}
                      <div className="p-1 rounded bg-white text-sm font-semibold w-fit">Bigflash</div>
                </div>
              </div>
              {/* EXPERIENCE LIST ITEM */}
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                    ...
                    {/* JOB DESC */}
                      <div className="p-3 text-sm italic">
                        I have done fornt end e-commerce app and getting a lot of experience and develop communication skills!
                      </div>
                    {/* JOB DATE */}
                      <div className="p-3 text-red-400 text-sm font-semibold">2016- 2018</div>
                    {/* COMPANY NAME */}
                      <div className="p-1 rounded bg-white text-sm font-semibold w-fit">EthioMoon</div>
                </div>
                {/* CENTER */}
                <div className="w-1/6">
                  {/* LINE */}
