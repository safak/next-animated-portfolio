...
{/*List items from hamberger menu*/}
    ...
    <div className='h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl'>
      ...
      <div className='md:hidden lg:flex xl:w-1/3 xl:justify-center' >
        <Link className='text-sm bg-black rounded-md p-1 font-semibold flex items-center justify-center' href="/">
            <span className='text-white mr-1'>Akshay</span>
            <span className='w-12 h-8 rounded bg-white text-black items-center justify-center p-1'>Sunil</span>
        </Link>
      </div>
      ...
      <div className='hidden md:flex gap-4 w-1/3' >
            ...
            <Link href="https://github.com/akshayofficial4" target='blank'>
            ...
            <Link href="https://www.linkedin.com/in/akshay-sunil7034/" target='blank'>
